...
perturbed_scenario <- function(sample_size,  true_model = c(-1.6,1), event_p=NA, noise_sd=NA, bias_OR=NA, n_out_sim=200, max_n_inner_sim=1000, zs=0.1, seed=NULL)
{
...
perturbed_scenarios <- function(sample_sizes = c(250, 500, 1000, 2000),
                                 event_ps = NULL,
                                 noise_sds = NULL,
                                 bias_ORs = 1,
                                 zs = c(0.1,0.2,0.3),
