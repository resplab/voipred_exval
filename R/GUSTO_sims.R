...
sim_by_size <- function(n_sim=100, sample_sizes=c(250, 500, 1000, 2000, 4000, 8000, Inf),zs=c(0.01,0.02,0.05,0.1))
{
  set.seed(1)
...
plot(pres[which(pres$method=="BB"),]$sample_size,pres[which(pres$method=="BB"),]$val1,type='l', xlab = "Sample size", ylab="EVPI", col='red4', lwd=2, ylim=c(0,max_y))
lines(pres[which(pres$method=="OB"),]$sample_size,pres[which(pres$method=="OB"),]$val1,col='blue4', lwd=2, lty=2)
lines(pres[which(pres$method=="asy"),]$sample_size,pres[which(pres$method=="asy"),]$val1,col='orange4', lwd=2, lty=3)

max_y <- max(pres[which(pres$method=="BB"),]$val2,pres[which(pres$method=="OB"),]$val2,pres[which(pres$method=="asy"),]$val2)
plot(pres[which(pres$method=="BB"),]$sample_size,pres[which(pres$method=="BB"),]$val2,type='l', xlab = "Sample size", ylab="EVPI", col='red4', lwd=2, xlim=c(0,9000), ylim=c(0,max_y))
lines(pres[which(pres$method=="OB"),]$sample_size,pres[which(pres$method=="OB"),]$val2,col='blue4', lwd=2, lty=2)
lines(pres[which(pres$method=="asy"),]$sample_size,pres[which(pres$method=="asy"),]$val2,col='orange4', lwd=2, lty=3)

max_y <- max(pres[which(pres$method=="BB"),]$val3,pres[which(pres$method=="OB"),]$val3,pres[which(pres$method=="asy"),]$val3)
plot(pres[which(pres$method=="BB"),]$sample_size,pres[which(pres$method=="BB"),]$val3,type='l', xlab = "Sample size", ylab="EVPI", col='red4', lwd=2, xlim=c(0,3000), ylim=c(0,max_y))
lines(pres[which(pres$method=="OB"),]$sample_size,pres[which(pres$method=="OB"),]$val3,col='blue4', lwd=2, lty=2)
lines(pres[which(pres$method=="asy"),]$sample_size,pres[which(pres$method=="asy"),]$val3,col='orange4', lwd=2, lty=3)

max_y <- max(pres[which(pres$method=="BB"),]$val4,pres[which(pres$method=="OB"),]$val4,pres[which(pres$method=="asy"),]$val4)
plot(pres[which(pres$method=="BB"),]$sample_size,pres[which(pres$method=="BB"),]$val4,type='l', xlab = "Sample size", ylab="EVPI", col='red4', lwd=2, xlim=c(0,3000), ylim=c(0,max_y))
lines(pres[which(pres$method=="OB"),]$sample_size,pres[which(pres$method=="OB"),]$val4,col='blue4', lwd=2, lty=2)
lines(pres[which(pres$method=="asy"),]$sample_size,pres[which(pres$method=="asy"),]$val4,col='orange4', lwd=2, lty=3)
